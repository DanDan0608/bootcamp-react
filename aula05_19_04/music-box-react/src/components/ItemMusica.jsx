...
function ItemMusica(props) { // componente ItemMusica que recebe parâmetros como "props" e retorna fragmento JSX
  ...
  const backgroundImage = {backgroundImage: `url(${props.imagem ? props.imagem : capaPadrao})`}
  
  return (
    <>
      <div className="card-music" style={backgroundImage}>  {/* componente com classe "card-music", utilizando className do React pois class é reservada do sistema */}
