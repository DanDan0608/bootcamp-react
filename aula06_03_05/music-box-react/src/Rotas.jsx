    ...
    <>
        <BrowserRouter> {/* Este é o navegador de rotas, do react-router-dom */}
            ...
            <Routes> {/* Este é o agrupador de rotas, do react-router-dom */}
                <Route path="/" element={<Home />}/> {/* Rota com o caminho "/", que ao acessar "http://localhost:3000/", renderizará o elemento/componente "Musicas.jsx" */}
                <Route path="/musicas" element={<Musicas />}/> {/* Rota com o caminho "/", que ao acessar "http://localhost:3000/", renderizará o elemento/componente "Musicas.jsx" */}
                ...
                <Route path="*" element={<NotFound />} /> {/* Rota com o caminho "/", que ao acessar "http://localhost:3000/adicionar", renderizará o elemento/componente "Adicionar.jsx" */}
            </Routes>
        </BrowserRouter>
    </>
    );
